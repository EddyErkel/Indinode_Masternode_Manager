...
DONADDR1="XIND: XPuit9PGmUnPUYdegjqeTzsabesPq3f5jR"
...
COIN_DAEMON="indinoded"
COIN_CLI="indinode-cli"
COIN_PID="indinoded.pid"
COIN_FOLDER="/root/.indinode"
COIN_CONFIG="indinode.conf"
COIN_SERVICE="indinode.service"
COIN_PORT="8696"
RPC_PORT="8698"
...
COIN_URL16="https://github.com/raymaker/indinode/releases/download/v.1.3.0/Indinode-1.3.0-x86_64-pc-linux-gnu.zip"  # Binaries compressed file for Ubuntu 16.
COIN_URL18="https://github.com/raymaker/indinode/releases/download/v.1.3.0/Indinode-1.3.0-x86_64-pc-linux-gnu.zip"  # Binaries compressed file for Ubuntu 18.
COIN_ZIPDIR="/"                                                                                     				# Path inside the zipfile that contains the binaries.


# Masternode Bootstrap URL
CHAIN_URL="https://www.dropbox.com/s/7wc6imyipfh33n1/indinode_CHAIN.tar.gz"											# Bootstrap URL. The Bootstrap is compressed file containing chain directory's.
...
NODES_URL="https://github.com/raymaker/indinode/releases/addnodes.txt"         									 	# Addnodes URL.
...
WWW_MAIN="https://indinode.me/"                                                             						# Main website URL
WWW_GHUB="https://github.com/raymaker/indinode/releases/"                                          					# Github URL
WWW_EXPL="http://explorer.indinode.me/"                                                        						# Explorer URL
# WWW_MNO="https://masternodes.online/currencies/XIND/"                                               				# Masternodes.Online URL
WWW_CMC="https://coinmarketcap.com/currencies/indinode/"                                              				# CoinMarketCap URL
...
function display_logo() {
    ...
    echo -e "${W}         ╚═╝╚═╝  ╚═══╝╚═════╝ ╚═╝╚═╝  ╚═══╝ ╚═════╝ ╚═════╝ ╚══════╝         	"; sleep $DELAY
    echo -e "${W}                                                                               "; sleep $DELAY
    echo -e "${W}         Indinode (XIND) is a community-focused, privacy-based coin            "; sleep $DELAY
    echo -e "${W}         that is driven to maintain sustainable growth, development            "; sleep $DELAY
    echo -e "${W}            and fair practices within the masternode coin space.               "; sleep $DELAY
    echo -e "${W}             Indinode is a self-funded, self-governed, private,                "; sleep $DELAY
    echo -e "${W}                     instant, and secure cryptocurrency.             			"; sleep $DELAY
    echo -e "${W}                                                                               "; sleep $DELAY
